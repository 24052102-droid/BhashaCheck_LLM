...
file_path = "../outputs/mt5_results.txt"
...
summary_df.to_csv(
    "../results/mt5_summary.csv",
    index=False
)

print("\nSaved: mt5_summary.csv")
...
plt.title("MT5 Language-wise Accuracy")
...
plt.savefig(
    "../results/mt5_accuracy_graph.png"
)

print(
    "Saved: mt5_accuracy_graph.png"
)
